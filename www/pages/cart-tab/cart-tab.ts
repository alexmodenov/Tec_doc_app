...
export class CartTabPage {
  ...
  constructor(public navCtrl: NavController, public modalCtrl: ModalController, public storage: Storage, public tbarService: TbarService,
    public wooService: WoocommerceService, public loadingCtrl: LoadingController, public appConfig: AppConfig, public userService: UserService, public alertCtrl: AlertController,
    public translateService: TranslateService) {
    this.isEmpty = false;
    this.tbarService.hideBar = false;
    this.errorModal = this.alertCtrl.create({
      title: 'Notice',
